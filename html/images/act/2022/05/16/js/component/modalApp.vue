      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content rounded-0">
          <div class="modal-header round">
            <h6 class="modal-title" id="eventModalLabel">活動日期：2022/04/07(四)-05/08(日)</h6>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            
            <!-- <h4>★活動日期：2022/04/07(四)-05/08(日)</h4> -->

            <!-- <h4>★活動內容：</h4> -->

            <div id="anchor-300" class="p-3">
              <h4 class="text-center">【滿額送】</h4>
              <p>2022/04/07(四)-05/08(日)累積消費淨額每滿3千元，送3百元銀幣，滿6千元送6百元銀幣，累計回饋無上限。於04/07(四)起每日結算並於4/21(四)開始發送銀幣。以系統簡訊通知會員；活動期間每月結算一次。銀幣使用期限：1個月(自發送日開始計算)。</p>  
            </div>

            <div id="anchor-pot" class="p-3">
              <h4 class="text-center">【滿額抽】</h4>
              <p>2022/04/07(四)-05/08(日)累積消費滿額即可參加抽獎，消費滿5000元(含)以上，即可抽簡單生活附蓋湯碗(參考市價469元，共200名)；消費滿1萬2千元(含)以上，即可抽HARIO冷泡咖啡壺(參考市價1,250元，共88名)，每人每門檻限得獎壹次。</p>  
