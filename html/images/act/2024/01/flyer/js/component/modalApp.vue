<template>
	<div>
    <!-- 【好禮三重抽】-->
    <div class="modal fade" id="eventModal-Wave2-G" tabindex="-1" aria-labelledby="eventModal-Wave2-G" aria-hidden="true" data-anchor-target="">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content rounded-0">
          ...
          <div class="modal-body">
            <h3 class="text-center p-0">【好禮三重抽】</h3>
            <div class="p-xl-2">
              <p class="mb-2">活動期間</p>
              <p class="mb-3">2024/1/8(一) 00:00-2024/2/18(日) 23:59。</p>  
            </div>
            <div class="p-xl-2">
              <p class="mb-2">活動內容</p>
              <p class="mb-2">活動期間全通路，累計消費滿以下金額即可抽好禮(不可跨層抽獎)。</p>
              <p class="mb-2">★第一重-活動期間累計消費滿$8,888元，即可抽【Jimnychuang】全效旅行組 Chunjing_(市售價$800元)_共6組</p>
              <p class="mb-2">★第二重-活動期間累計消費滿$12,888元，即可抽JO MALONE青檸羅勒與柑橘護手霜50ml_(市售價$1,600元)_共計10組</p>
              <p class="mb-3">★第三重-活動期間累計消費滿$58,888元，即可抽【 Hamilton Beach 漢美馳 】 二合一低溫舒肥慢燉鍋(33970 TW)_(市售價$4,490元)_共計3組</p>
            </div>
            
            <h3 class="text-center">注意事項</h3>
            <ol class="list-group list-group-flush mb-4">
              <li class="list-group-item">抽獎通知，將於活動結束後2024/3/4(四)由電腦隨機抽出，獲獎者後續將於專人電話通知，並寄送領獎通知回函，回函請2024/3/31(日)前寄回，否則將視同放棄。</li>
    ...
    <!-- 【多買多賺】-->
    <div class="modal fade" id="eventModal-Wave2-F" tabindex="-1" aria-labelledby="eventModal-Wave2-F" aria-hidden="true" data-anchor-target="">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content rounded-0">
          <div class="modal-header rounded-0 bg-red">
            <h6 class="modal-title text-white">活動說明</h6>
          ...
          <div class="modal-body">
            <h3 class="text-center p-0">【多買多賺】</h3>
            <div class="p-xl-2">
              <p class="mb-2">活動期間</p>
              <p class="mb-3">2024/1/8(一) 00:00-2024/2/18(日) 23:59。</p>  
            </div>
            <div class="p-xl-2">
              <p class="mb-2">活動內容</p>
              <p class="mb-3">活動期間累計消費每滿$2,000元送$200元銀幣。(最高回饋2.4萬)</p>
            </div>
            
            <h3 class="text-center">注意事項</h3>
            <ol class="list-group list-group-flush mb-4">
              <li class="list-group-item">於2024/1/8(一)起每日結算並於2024/1/22(一)開始發送銀幣，以系統簡訊通知會員；活動期間每月結算一次。</li>
