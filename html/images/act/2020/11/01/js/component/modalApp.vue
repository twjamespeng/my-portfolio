      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content rounded-0">
          <div class="modal-header round">
            <h5 class="modal-title" id="eventModalLabel">活動說明及注意事項</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <h3 class="text-center">活動說明</h3>
            <h4>【買就送】</h4>
            <ul class="list-group list-group-flush mb-4">
              <li class="list-group-item">11/1(日)當天購買<span class="text-danger">好康無法檔</span>商品，且15天無取消退貨，活動結束後即可獲得1,100元購物金，每檔商品限領一次，每名會員不限領一次。購物金發送後，以系統簡訊通知會員。購物金使用期限至<span class="text-danger">2021/2/28(日)止。</span></li>
            </ul>
            <h4>【滿額送】</h4>
            <ul class="list-group list-group-flush mb-4">
              <li class="list-group-item">11/1(日)~11/30(一)累積消費淨額每滿3千元，送5百元購物金，滿6千元送1千元購物金，累計回饋無上限。超過3千之餘額可累計至下次消費淨額，11/1(日)起每日結算並於12/15(二)開始發送購物金。購物金使用期限：3個月(自發送日開始計算)。活動排除指定商品、加價購及員購。</li>
            </ul>
            <h4>【週週抽】</h4>
            <ul class="list-group list-group-flush mb-4">
              <li class="list-group-item">活動期間消費即可參加抽獎活動。以商品數計，買越多中獎機會越大。</li>
              <li class="list-group-item">抽獎時間與方式：以電腦隨機方式抽出符合資格之中獎人，於ViVaTV網站公告中獎人部份姓名、居住縣市及中獎內容。</li>
              <li class="list-group-item">中獎通知：本公司客服同仁將於抽獎日後3日內電話通知中獎人並發出中獎通知函。</li>
              <li class="list-group-item">領獎資格：抽獎後15日內扣除取消退貨，若交易件數=0，則取消領獎資格，該獎項不再補抽。</li>
            </ul>
            ...
            <ol class="list-group list-group-flush mb-4">
              ...
              <li class="list-group-item">ViVa TV購物金、生日禮金、禮金、商品抵用金之使用方式請詳閱官網「<a :href="faqURL" target="_blank">常見問題解答</a>」，或洽客服專線0809-052-777</li>
          ...
          <!-- <div class="modal-footer">
            <button type="button" class="btn btn-outline-secondary rounded-0" data-dismiss="modal">OK</button>
          </div> -->
        </div>
      </div>
    </div>
