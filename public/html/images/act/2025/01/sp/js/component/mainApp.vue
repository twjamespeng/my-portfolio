...
module.exports = {
  ...
  components: {
    'item-app': httpVueLoader('/html/images/act/2025/01/sp/js/component/itemApp.vue'),
    'modal-app': httpVueLoader('/html/images/act/2025/01/sp/js/component/modalApp.vue')
  },
  methods: {
    init: function() {
      var main = this;
