    ...
    <div class="d-flex flex-column position-relative">
      ...
      <div class="landing-main">
        <picture class="d-block position-relative" style="z-index: 2;">
          <!-- <source srcset="images/act/2023/11/flyer/images/wave1/landing-main.jpg" media="(min-width: 1921px)"> -->
          <source srcset="images/act/2023/11/flyer/images/wave1/landing-main.jpg" media="(min-width: 992px)">
          <img class="img-fluid pe-none us-none" src="images/act/2023/11/flyer/images/wave1/mobile/landing-main.jpg" alt="landing-main">
        </picture>
      </div>
...
module.exports = {
  ...
  components: {
    'item-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/my-portfolio" : "") + "/html/images/act/2023/11/flyer/js/component/itemApp.vue'),
    'modal-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/my-portfolio" : "") + "/html/images/act/2023/11/flyer/js/component/modalApp.vue')
  },
  methods: {
    init: function() {
      var main = this;
      ...
      if (timeFromURL) {
        ...
        if (timeFromURL.substr(0,8) == '20230424') {
          ...
          $("meta[property='og:image']").attr("content", "https://www.vivatv.com.tw/html/images/act/2023/11/flyer/images/og-wave2.jpg");
