...
module.exports = {
  ...
  components: {
    'item-app': httpVueLoader('/html/images/act/2022/05/16/js/component/itemApp.vue'),
    'modal-app': httpVueLoader('/html/images/act/2022/05/16/js/component/modalApp.vue')
  },
  methods: {
    init: function() {
      var main = this;
