...
module.exports = {
  ...
  components: {
    'item-app': httpVueLoader('/html/images/act/2020/11/01/js/component/itemApp.vue'),
    'modal-app': httpVueLoader('/html/images/act/2020/11/01/js/component/modalApp.vue')
  },
  methods: {
    init: function() {
      var main = this;
