...
module.exports = {
  ...
  components: {
    'item-app': httpVueLoader('/html/images/act/2023/05/flyer/js/component/itemApp.vue'),
    'modal-app': httpVueLoader('/html/images/act/2023/05/flyer/js/component/modalApp.vue')
  },
  methods: {
    init: function() {
      var main = this;
