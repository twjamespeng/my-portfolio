  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-6xl px-6">
        <h2 className="text-3xl font-bold mb-6">抽獎活動頁 <span className="text-teal-500">Events</span></h2>
        <p className="text-lg text-gray-300 mb-6">依行銷活動需求，提供<span className="text-teal-500 font-semibold mx-1">視覺設計、頁面切版及遊戲互動機制</span>，並由IT同仁提供API接口進行串接。</p>
