...
module.exports = {
  ...
  components: {
    'item-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/my-portfolio" : "") + "/html/images/act/2022/07/anniversary/js/component/itemApp.vue"),
    'modal-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/my-portfolio" : "") + "/html/images/act/2022/07/anniversary/js/component/modalApp.vue")
  },
  methods: {
    init: function() {
      var main = this;
